...
package com.aurora.quickstep.views;
...
import static com.aurora.launcher.anim.Interpolators.ACCEL_2;
import static com.aurora.launcher.anim.Interpolators.FAST_OUT_SLOW_IN;
import static com.aurora.launcher.anim.Interpolators.LINEAR;
import static com.aurora.launcher.util.SystemUiController.UI_STATE_OVERVIEW;
import static com.aurora.quickstep.TaskUtils.checkCurrentOrManagedUserId;
import static com.aurora.quickstep.WindowTransformSwipeHandler.MIN_PROGRESS_FOR_OVERVIEW;
...
import com.aurora.launcher.anim.PropertyListBuilder;
...
import com.aurora.launcher.util.PendingAnimation;
import com.aurora.launcher.util.Themes;
import com.aurora.quickstep.OverviewCallbacks;
import com.aurora.quickstep.QuickScrubController;
import com.aurora.quickstep.RecentsModel;
import com.aurora.quickstep.TaskUtils;
import com.aurora.quickstep.util.ClipAnimationHelper;
import com.aurora.quickstep.util.TaskViewDrawable;

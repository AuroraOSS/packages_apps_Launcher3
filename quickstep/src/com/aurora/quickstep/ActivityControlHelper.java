...
import static com.aurora.launcher.LauncherState.FAST_OVERVIEW;
...
import static com.aurora.quickstep.views.RecentsView.CONTENT_ALPHA;
...
import com.aurora.launcher.LauncherInitListener;
...
import com.aurora.launcher.uioverrides.FastOverviewState;
...
import com.aurora.quickstep.util.LayoutUtils;
...
import com.aurora.quickstep.views.LauncherLayoutListener;
...
public interface ActivityControlHelper<T extends BaseDraggingActivity> {
    ...
    /**
     * Used for containerType in {@link com.aurora.launcher.logging.UserEventDispatcher}
     */

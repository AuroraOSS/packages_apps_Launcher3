 ...
 */
package com.aurora.quickstep;

import static com.aurora.launcher.BaseActivity.INVISIBLE_BY_STATE_HANDLER;
import static com.aurora.launcher.BaseActivity.STATE_HANDLER_INVISIBILITY_FLAGS;
import static com.aurora.launcher.Utilities.SINGLE_FRAME_MS;
...
import static com.aurora.launcher.anim.Interpolators.OVERSHOOT_1_2;
import static com.aurora.quickstep.QuickScrubController.QUICK_SCRUB_FROM_APP_START_DURATION;
import static com.aurora.quickstep.TouchConsumer.INTERACTION_NORMAL;
import static com.aurora.quickstep.TouchConsumer.INTERACTION_QUICK_SCRUB;
import static com.aurora.quickstep.views.RecentsView.UPDATE_SYSUI_FLAGS_THRESHOLD;
...
import com.aurora.launcher.anim.AnimationSuccessListener;
...
import com.aurora.launcher.userevent.nano.LauncherLogProto.Action.Touch;
...
import com.aurora.quickstep.ActivityControlHelper.ActivityInitListener;
import com.aurora.quickstep.ActivityControlHelper.AnimationFactory;
import com.aurora.quickstep.ActivityControlHelper.LayoutListener;
import com.aurora.quickstep.TouchConsumer.InteractionType;
import com.aurora.quickstep.util.ClipAnimationHelper;
import com.aurora.quickstep.util.RemoteAnimationTargetSet;
import com.aurora.quickstep.util.TransformedRect;

...
import static com.aurora.launcher.BaseActivity.INVISIBLE_ALL;
import static com.aurora.launcher.BaseActivity.INVISIBLE_BY_APP_TRANSITIONS;
import static com.aurora.launcher.BaseActivity.INVISIBLE_BY_PENDING_FLAGS;
import static com.aurora.launcher.BaseActivity.PENDING_INVISIBLE_BY_WALLPAPER_ANIMATION;
...
import static com.aurora.launcher.Utilities.postAsyncCallback;
import static com.aurora.launcher.allapps.AllAppsTransitionController.ALL_APPS_PROGRESS;
import static com.aurora.launcher.anim.Interpolators.AGGRESSIVE_EASE;
import static com.aurora.launcher.anim.Interpolators.DEACCEL_1_7;
import static com.aurora.launcher.anim.Interpolators.LINEAR;
import static com.aurora.launcher.dragndrop.DragLayer.ALPHA_INDEX_TRANSITIONS;
import static com.aurora.quickstep.TaskUtils.findTaskViewToLaunch;
import static com.aurora.quickstep.TaskUtils.getRecentsWindowAnimator;
import static com.aurora.quickstep.TaskUtils.taskIsATargetWithMode;
...
import com.aurora.launcher.DeviceProfile.OnDeviceProfileChangeListener;
import com.aurora.launcher.InsettableFrameLayout.LayoutParams;
import com.aurora.launcher.allapps.AllAppsTransitionController;
import com.aurora.launcher.anim.AnimatorPlaybackController;
...
import com.aurora.launcher.shortcuts.DeepShortcutView;
import com.aurora.launcher.util.MultiValueAlpha;
import com.aurora.launcher.util.MultiValueAlpha.AlphaProperty;
import com.aurora.quickstep.util.ClipAnimationHelper;
import com.aurora.quickstep.util.MultiValueUpdateListener;
import com.aurora.quickstep.util.RemoteAnimationProvider;
import com.aurora.quickstep.util.RemoteAnimationTargetSet;
import com.aurora.quickstep.views.RecentsView;
import com.aurora.quickstep.views.TaskView;

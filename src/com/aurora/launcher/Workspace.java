...
import com.aurora.launcher.Launcher.LauncherOverlay;
import com.aurora.launcher.LauncherAppWidgetHost.ProviderChangedListener;
import com.aurora.launcher.LauncherStateManager.AnimationConfig;
import com.aurora.launcher.accessibility.AccessibleDragListenerAdapter;
import com.aurora.launcher.accessibility.WorkspaceAccessibilityHelper;
import com.aurora.launcher.anim.AnimatorSetBuilder;
import com.aurora.launcher.anim.Interpolators;
import com.aurora.launcher.badge.FolderBadgeInfo;
...
import com.aurora.launcher.dragndrop.DragOptions;
import com.aurora.launcher.dragndrop.DragView;
import com.aurora.launcher.dragndrop.SpringLoadedDragController;
import com.aurora.launcher.folder.Folder;
import com.aurora.launcher.folder.FolderIcon;
import com.aurora.launcher.folder.PreviewBackground;
import com.aurora.launcher.graphics.DragPreviewProvider;
import com.aurora.launcher.graphics.PreloadIconDrawable;
import com.aurora.launcher.pageindicators.WorkspacePageIndicator;
import com.aurora.launcher.popup.PopupContainerWithArrow;
import com.aurora.launcher.shortcuts.ShortcutDragPreviewProvider;
import com.aurora.launcher.touch.ItemLongClickListener;
import com.aurora.launcher.touch.WorkspaceTouchListener;
...
import com.aurora.launcher.util.LongArrayMap;
import com.aurora.launcher.util.PackageUserKey;
import com.aurora.launcher.util.Thunk;
import com.aurora.launcher.util.WallpaperOffsetInterpolator;
...
import static com.aurora.launcher.LauncherAnimUtils.OVERVIEW_TRANSITION_MS;
import static com.aurora.launcher.LauncherAnimUtils.SPRING_LOADED_EXIT_DELAY;
import static com.aurora.launcher.LauncherAnimUtils.SPRING_LOADED_TRANSITION_MS;
import static com.aurora.launcher.LauncherState.ALL_APPS;
import static com.aurora.launcher.LauncherState.NORMAL;
import static com.aurora.launcher.LauncherState.SPRING_LOADED;
import static com.aurora.launcher.dragndrop.DragLayer.ALPHA_INDEX_OVERLAY;
